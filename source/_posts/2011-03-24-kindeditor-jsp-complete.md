...
![kindeditor-jsp-cmp-1](http://myblog.lisenhui.cn/kindeditor-jsp-cmp-1.png-alias)

* 完整功能示

![kindeditor-jsp-cmp-2](http://myblog.lisenhui.cn/kindeditor-jsp-cmp-2.png-alias)

* 浏览服务目录

![kindeditor-jsp-cmp-3](http://myblog.lisenhui.cn/kindeditor-jsp-cmp-3.png-alias)

* 附件展示效果

![kindeditor-jsp-cmp-4](http://myblog.lisenhui.cn/kindeditor-jsp-cmp-4.png-alias)

* 与Extjs整合效果

![kindeditor-jsp-cmp-6](http://myblog.lisenhui.cn/kindeditor-jsp-cmp-6.png-alias)
