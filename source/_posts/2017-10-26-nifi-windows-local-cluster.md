...
![WIN-NIFI-CLUSTER-00](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-00.png-alias)
![WIN-NIFI-CLUSTER-01](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-01.png-alias)
...
![WIN-NIFI-CLUSTER-02](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-02.png-alias)
![WIN-NIFI-CLUSTER-03](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-03.png-alias)
...
![WIN-NIFI-CLUSTER-04](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-04.png-alias)
![WIN-NIFI-CLUSTER-05](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-05.png-alias)
![WIN-NIFI-CLUSTER-044](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-044.png-alias)
...
![WIN-NIFI-CLUSTER-06](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-06.png-alias)
...
![WIN-NIFI-CLUSTER-07](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-07.png-alias)
![WIN-NIFI-CLUSTER-08](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-08.png-alias)

## 启动流程

点击NIFI页面左下角的`NiFi Flow`链接返回到主面板，点击`WordCountDemo`组，然后点击左侧面板中的开始按钮启动流程，如下图所示：

![WIN-NIFI-CLUSTER-09](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-09.png-alias)


如无异常那么此时你可在目录下找到名为**telltale_heart_wordcount**的文件，打开便可看到如下图的统计内容：

![WIN-NIFI-CLUSTER-10](http://myblog.lisenhui.cn/WIN-NIFI-CLUSTER-10.png-alias)
