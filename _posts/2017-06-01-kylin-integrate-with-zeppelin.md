...
category: BigData
tags: [bigdata,kylin,zeppelin]
keywords: "kylin;zeppelin;"
description: "Kylin集成Zeppelin展示数据"
---
...
![zeppelin-01.png]({{site.cdn.img}}/zeppelin-01.png{{site.cdn.img-ext}})


OK, 接下来就是创建与Kylin的连接，在Zeppelin中叫做`Interpreter`, 点击页面右上角的`anonymous`选择它如下图所示：

![zeppelin-02.png]({{site.cdn.img}}/zeppelin-02.png{{site.cdn.img-ext}})

同样的点击右上角的`Create`按钮，参考下图填写的数据填写你的真实数据：

![zeppelin-03.png]({{site.cdn.img}}/zeppelin-03.png{{site.cdn.img-ext}})

保存好后，点击左上角的`Notebook`--> `+ Create new note`如下图所示：

![zeppelin-04.png]({{site.cdn.img}}/zeppelin-04.png{{site.cdn.img-ext}})
...
![zeppelin-05.png]({{site.cdn.img}}/zeppelin-05.png{{site.cdn.img-ext}})
