...
3. 使用 `Crtl+P` 快捷键打开 `Sublime Text` 的搜索功能，拷贝领取任务中的文章路径，分别打开 `en` 和 `zh` 目录下对应的文件，如下图所示：![03-21-join-istio-translation-org-05.png](http://myblog.lisenhui.cn/2021/03-21-join-istio-translation-org-05.png-alias)
