...
1. In your own repository, create a new PR request, as shown inthe following image: ![03-21-join-istio-translation-org-01.png](http://imgs.lisenhui.cn/2021/03-21-join-istio-translation-org-01.png)
2. Refer to the digital order of the pictures below, adjust the corresponding warehouse name and branch (on the left is your own warehouse, on the right is the official warehouse), click on the green button on the right, fill in the relevant review information (mainly you can understand the good, no standards)![03-21-join-istio-translation-org-02.png](http://imgs.lisenhui.cn/2021/03-21-join-istio-translation-org-02.png) ![03-21-join-istio-translation-org-03.png](http://imgs.lisenhui.cn/2021/03-21-join-istio-translation-org-03.png)
3. Then automatically jump to that PR and find the `Merge pull request` green  button below to click and confirm it; ![03-21-join-istio-translation-org-04.png](http://imgs.lisenhui.cn/2021/03-21-join-istio-translation-org-04.png)
